...
async def send_video_handler(bot, cmd, output_vid, video_thumbnail, duration, width, height, editable, logs_msg, file_size):
    ...
    sent_vid = await bot.send_video(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Channel Utama", url="https://t.me/mantapvids")],
                                           [InlineKeyboardButton("Channel Bot", url="https://t.me/mantapfilestorage")],
                                           [InlineKeyboardButton("Sawer Admin", url="https://saweria.co/mantapjozzchannel")]]),
